(function () {
	...
	button.onclick = function () {
		if (-1 !== container.className.indexOf('toggled')) {
			...
			button.innerHTML = winslowL10n.menu;
			menu.setAttribute('aria-expanded', 'false');
		} else {
			container.className += ' toggled';
			button.setAttribute('aria-expanded', 'true');
			button.innerHTML = winslowL10n.close;
	...
	if (commentList) {
		...
		var toggleText = winslowL10n.comments_show;
		...
		commentToggle.onclick = function () {
			...
			if (this.innerHTML == toggleText) {
				commentToggle.innerHTML = winslowL10n.comments_hide;
			}
			else {
				commentToggle.innerHTML = toggleText;
			};
